...
export default function HomeScreen({ setShowSpendMoney }) {
  ...
  return (
    <>
      <AddMoney modalVisible={modalVisible} setModalVisible={setModalVisible} />
      <TopBar title={"Home"} />
      ...
      <View style={style.part2}>
        <View style={style.moneyAmountBadge}>
          <AppText fontSize={28} content={`$ ${state.currentMoney} `} />
        </View>
      </View>
